...
import com.example.quizleaderboardswimup.Adapter.BookmarkAdapter;
...
public class BookmarkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbarBM);
        questionsView = findViewById(R.id.bookmark_recycle_view);
